...
export const HeroSection = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background text-foreground">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-xl sm:text-2xl md:text-3xl text-primary font-medium mb-6" style={{ color: 'hsl(var(--primary))' }}>
          {title}
        </p>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10">
        <Link href="#about" onClick={handleScrollToAbout} aria-label="Scroll to about section">
          <ArrowDownCircle className="h-10 w-10 text-primary animate-bounce" style={{ color: 'hsl(var(--primary))' }}/>
        </Link>
      </div>
    </section>
  );
